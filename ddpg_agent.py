...
class Agent():
    def __init__(self, state_size, action_size, random_seed=42):
        ...
        self.i_step = 1 # For learn every 20 steps
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        if (len(self.memory) > BATCH_SIZE) and (self.i_step % 20 == 0): # learn every 20 steps
            for _ in range(10): # samples multiple the experience 
...
class OUNoise:
    ...
    def __init__(self, size, random_seed, mu=0., theta=OU_THETA, sigma=OU_SIGMA):
